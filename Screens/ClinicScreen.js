...
const ClinicScreen = () => {
  ...
  const handleCall = () => {
    navigation.navigate('CallScreen2');
  };
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/CalenderScreen/ClinicScreen/clinic-background.png')} style={styles.backgroundImage} />
      ...
      >
        <View style={styles.clinicInfoContainer}>
          <Text style={styles.mainTitle}>Phòng khám thú y PetPro</Text>

          {/* Clinic Card */}
          <View style={styles.cardContainer}>
            <Image source={require('../assets/CalenderScreen/ClinicScreen/clinic1-image.png')} style={styles.clinicImage} />
            <View style={styles.clinicInfo}>
              <Text style={styles.clinicTitle}>{clinicData?.name || 'Phòng khám thú y PetPro'}</Text>
              <View style={styles.clinicDetailContainer}>
                <Image source={require('../assets/CalenderScreen/ClinicScreen/location-icon.png')} style={styles.icon} />
            ...
            <TouchableOpacity style={styles.favoriteIcon} onPress={handleFavoriteToggle}>
              <Image 
                source={require('../assets/CalenderScreen/ClinicScreen/heart-icon.png')} 
          ...
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionText}>
              Bệnh Viện Thú Y PETPRO là đơn vị cung cấp đầy đủ nhất các dịch vụ dành cho thú cưng trên thị trường hiện nay.
            </Text>
          </View>
        </View>
      </ScrollView>
      ...
      <View style={styles.fixedButtonContainer}>
        <TouchableOpacity style={styles.button} onPress={handleChat}>
          <Image source={require('../assets/CalenderScreen/ClinicScreen/message-icon.png')} style={styles.buttonIcon} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.bookButton} onPress={() => {/* Booking handler */}}>
          <Text style={styles.bookButtonText}>Đặt lịch</Text>
          <Image source={require('../assets/CalenderScreen/ClinicScreen/continue-icon.png')} style={styles.continueIcon} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={handleCall}>
          <Image source={require('../assets/CalenderScreen/ClinicScreen/call-icon.png')} style={styles.buttonIcon} />
        </TouchableOpacity>
      </View>
